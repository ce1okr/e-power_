...
public class EmpoweredSMP extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        extraInventoryManager = new ExtraInventoryManager(dataManager, abilityManager, config);
        ...
        pm.registerEvents(new EnforcementListener(abilityManager, cooldownManager, config), this);
        pm.registerEvents(new SurgeListener(this, abilityManager, cooldownManager, config), this);
        pm.registerEvents(new CombatListener(abilityManager, config), this);
        ...
        pm.registerEvents(new EnderPearlListener(cooldownManager, config), this);
        ...
        effectManager = new EffectManager(this, abilityManager, config);
        effectManager.start();
